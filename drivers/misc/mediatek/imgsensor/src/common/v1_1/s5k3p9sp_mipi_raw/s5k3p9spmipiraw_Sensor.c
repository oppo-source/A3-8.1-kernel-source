...
static struct imgsensor_info_struct imgsensor_info = {
		.sensor_id = S5K3P9SP_SENSOR_ID - 1,
		#ifdef VENDOR_EDIT
		/*Caohua.Lin@Camera.Driver add for 18011/18311  board 20180723*/
		...
		.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_4CELL_BAYER_Gr,//3p9sp remosaic awb  by wuxiao 20180822
		.mclk = 24,
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] =
{
	...
	#if USE_REMOSAIC
	{ 4640,  3488,    0,	0, 4640, 3488, 4640,  3488, 0000, 0000, 4640,  3488,      0,	0, 4640, 3488}, // capture remosic
	#else
...
static void sensor_init(void)
{
	...
	iWriteRegI2C((u8*)uTnpArrayInit , (u16)sizeof(uTnpArrayInit), imgsensor.i2c_write_id);
	...
	//Caohua.Lin@Camera, add for output first frame in stable
	write_cmos_sensor_16_16(0x6028, 0x2000); // global
	write_cmos_sensor_16_16(0x602A, 0x0FF4);
	write_cmos_sensor_16_16(0x6F12, 0x0100);
	write_cmos_sensor_16_16(0x6F12, 0x1700); //1700=5.88ms
	#else
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  S5K39PSP04_OTP_ERROR_CODE:%d \n", *feature_data,S5K3P9SP_OTP_ERROR_CODE);
		switch (*feature_data) {
			case 0:    //info type: otp state
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5K3P9SP_OTP_ERROR_CODE;//otp_state
...
UINT32 S5K3P9SP_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
