...
** VENDOR_EDIT
** File: - oppo18311_tianma_nt36672a_1080p_dsi_vdo.c
...
//#endif
	...
	*/
#ifndef BUILD_LK
	register_device_proc("lcd", "nt36672a", "tianma vdo mode");
#endif
}
...
{
	LCD_DEBUG("[tianma] lcm_init_power\n");
...
{
	LCD_DEBUG("[tianma] lcm_suspend_power\n");
	lcd_rst_setting(0);
	MDELAY(6);
...
{
	LCD_DEBUG("[tianma]lcm_initialization_setting\n");
...
LCM_DRIVER oppo18311_tianma_nt36672_1080p_dsi_vdo_lcm_drv=
{
	.name = "oppo18311_tianma_nt36672_1080p_dsi_vdo",
