...
#define REGFLAG_DELAY      0xE0
#define REGFLAG_UDELAY     0xE1

#define REGFLAG_END_OF_TABLE   0xE2
#define REGFLAG_RESET_LOW  0xE3
#define REGFLAG_RESET_HIGH  0xE4
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch = 224;
	...
	*/
	 ...
	 */
	register_device_proc("lcd", "nt36525", "boe vdo mode");
#endif
}
...
static void poweron_before_ulps(void) {
	...
	/*
	 * YongPeng.Yi@PSW.MM.Display.LCD.Stability, 2018/03/25,
	 * add for lcd rst one more time to avoid wakeup display color line
	 */
	lcd_rst_setting(1);
	MDELAY(10);
	lcd_rst_setting(0);
...
/*
 * Ling.Guo@PSW.MultiMedia.Display.LCD.Stability, 2017/12/22,
 * add for 17111 nt timing need
 */
 ...
 */
int boe_nt36525_lcm_set_cabc_mode(void *handle,int mode)
{
	int mapped_level = 0;
...
LCM_DRIVER oppo17101_boe_nt36525_720p_dsi_vdo_lcm_drv=
{
	.name = "oppo17101_boe_nt36525_720p_dsi_vdo",
