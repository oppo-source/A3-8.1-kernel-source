...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	*/
	 ...
	 */
	register_device_proc("lcd", "nt36525", "truly vdo mode");
#endif
}
 ...
 */
int truly_nt36525_lcm_set_cabc_mode(void *handle,int mode)
{
	int mapped_level = 0;
...
LCM_DRIVER oppo17101_truly_nt36525_720p_dsi_vdo_lcm_drv=
{
	.name = "oppo17101_truly_nt36525_720p_dsi_vdo",
