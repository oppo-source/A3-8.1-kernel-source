...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	*/
	 ...
	 */
	register_device_proc("lcd", "ft8006m", "truly vdo mode");
#endif
}
 ...
 */
int truly_ft8006m_lcm_set_cabc_mode(void *handle,int mode)
{
	int mapped_level = 0;
...
LCM_DRIVER oppo17101_truly_ft8006m_720p_dsi_vdo_lcm_drv=
{
	.name = "oppo17101_truly_ft8006m_720p_dsi_vdo",
