...
static struct LCM_setting_table lcm_initialization_video_setting[] = {
	...
	// CA
	{0xCA,65, {0x1D,0xEC,0xFC,0xF0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
...
#ifndef BUILD_LK
	register_device_proc("lcd", "td4330_dpt", "dsjm cmd mode");
#endif
}
...
LCM_DRIVER oppo_dpt_jdi_td4330_1080p_dsi_cmd_lcm_drv=
{
	.name = "oppo_dpt_jdi_td4330_1080p_dsi_cmd",
