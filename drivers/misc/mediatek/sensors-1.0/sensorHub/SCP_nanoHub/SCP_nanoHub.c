...
#ifdef VENDOR_EDIT
/*zhq@PSW.BSP.Sensor, 2018/03/24, Add for free fall and pickup motion*/
	mSensorState[ID_FREE_FALL].sensorType = ID_FREE_FALL;
	mSensorState[ID_FREE_FALL].rate = SENSOR_RATE_ONCHANGE;
	mSensorState[ID_FREE_FALL].timestamp_filter = false;

    mSensorState[ID_PICKUP_MOTION].sensorType = ID_PICKUP_MOTION;
    mSensorState[ID_PICKUP_MOTION].rate = SENSOR_RATE_ONCHANGE;
    mSensorState[ID_PICKUP_MOTION].timestamp_filter = false;
#endif /*VENDOR_EDIT*/
}
