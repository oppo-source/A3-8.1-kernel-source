...
extern void oppo_chg_set_chargerid_switch_val(int value);
...
#ifdef VENDOR_EDIT
//PengNan@BSP.CHG.Basic, 2017/08/11, add for oppo fastcharger plug interrupt.
...
#ifdef VENDOR_EDIT
//PengNan@BSP.CHG.Basic, 2017/08/11, add for vooc kpoc.
			if(oppo_is_vooc_project() == 0){
				mt_power_off();
			}
#else /*VENDOR_EDIT*/
				mt_power_off();		
