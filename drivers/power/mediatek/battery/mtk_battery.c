...
extern int oppo_chg_check_chip_is_null(void);
extern bool is_vooc_project(void);
...
void fg_custom_init_from_header(void)
{
    ...
    if(is_project(OPPO_18011)) {
        fg_cust_data.pmic_min_vol_t0 = 33800;
        fg_cust_data.pmic_min_vol_t1 = 33800;
    }
    ...
    if(is_project(OPPO_18011)) {
        fg_cust_data.qmax_sys_vol_t0 = 33850;
        fg_cust_data.qmax_sys_vol_t1 = 33850;
    }
	if(is_project(OPPO_18611)) {
			fg_cust_data.qmax_sys_vol_t2 = 33850;
			fg_cust_data.qmax_sys_vol_t3 = 34500;
		}
	...
	fg_cust_data.full_tracking_bat_int2_multiply = FULL_TRACKING_BAT_INT2_MULTIPLY;
	...
	if (is_project(17197) || is_project(18311) || is_project(18011) || is_project(OPPO_18611)) {
...
void fg_custom_init_from_dts(struct platform_device *dev)
{
	struct device_node *np = dev->dev.of_node;
	unsigned int val = 0;
	unsigned int val_0 = 0, val_1 = 0, val_2 = 0, val_3 = 0;
...
void bmd_ctrl_cmd_from_user(void *nl_data, struct fgd_nl_msg_t *ret_msg)
{
	...
	case FG_DAEMON_CMD_SET_RTC_UI_SOC:
	{
		...
		if (rtc_ui_soc < 0) {
			bm_err("[fg_res]FG_DAEMON_CMD_SET_RTC_UI_SOC error,rtc_ui_soc=%d\n", rtc_ui_soc);
			rtc_ui_soc = 0;
		}
...
//PengNan@BSP.CHG.Basic, 2017/09/07, add for compatabling two fuelgauge.
	...
	if (is_recovery_mode()) {
		if (is_project(OPPO_17331) || is_project(OPPO_17061) || is_project(OPPO_17175)
			|| is_project(OPPO_18011) || (get_Operator_Version() == OPERATOR_18328_ASIA_SIMPLE_NORMALCHG) || is_project(OPPO_18611)) {
...
/* Qiao.Hu@EXP.BSP.BaseDrv.CHG.Basic, 2017/08/15, Add for charger full status */
	...
	#ifdef VENDOR_EDIT
	//PengNan@BSP.CHG.Basic, 2017/09/07, add for compatabling two fuelgauge.
	if(is_project(OPPO_17331) || is_project(OPPO_17061) || is_project(OPPO_17175) || is_project(OPPO_17111) || is_project(OPPO_18011) || is_project(OPPO_17111)){
...
static int meter_fg_30_get_average_current(void)
{
    ...
    printk("meter_fg_30_get_average_current =%d\n",ret);
	ret = ret / 10;
...
static int battery_type_check(void)
{
	...
	if(is_project(OPPO_17331) || is_project(OPPO_17061) || is_project(OPPO_17175) || is_project(OPPO_18011) || is_project(OPPO_17111) || (get_Operator_Version() == OPERATOR_18328_ASIA_SIMPLE_NORMALCHG) || is_project(OPPO_18611)){		
